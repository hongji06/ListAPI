...
int main_LinkStackTest()
{
	...
	Teacher tempTeacher = (Teacher)LinkStack_Top(stack);
	printf("top of stack is :%d,%s\n", tempTeacher->age, tempTeacher->name);

	tempTeacher = (Teacher)LinkStack_Pop(stack);
	printf("pop of stack is :%d,%s\n", tempTeacher->age, tempTeacher->name);

	tempTeacher = (Teacher)LinkStack_Top(stack);
	printf("top of stack is :%d,%s\n", tempTeacher->age, tempTeacher->name);
